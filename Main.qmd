...
```{r, echo=FALSE}
#Table1
table1 <- rbind(screendataorg, screendatacpase, inthosdata, unitdata, screentypedata, settingcount, resistancedata, adldata, areadata)

colnames(table1)[c(1,7:14)] <- c("Index organism", "Index case mechansim", "History of travel", "High acquity units", "Index case risk factors", "Facility type", "Is index organism Pan-R", "Index case require ADL", "Index case use common areas")
...
screentypedata2 %>% table2clean(2019, positive_id, screening_type)
